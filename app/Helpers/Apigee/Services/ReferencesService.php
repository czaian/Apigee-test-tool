...
use App\Helpers\Apigee\Clients\ReferenceClient;
use App\Helpers\Apigee\Helpers\ConfigEnum;
use App\Helpers\Apigee\Helpers\ServiceAbstract;

class ReferencesService extends ServiceAbstract
{
    private array $Environments;
    private ReferenceClient $client;
    ...
    public function __construct(ConfigEnum $configKey = ConfigEnum::ConfigOriginKey)
    {
        ...
        $this->client = new ReferenceClient($this->config);
    }
