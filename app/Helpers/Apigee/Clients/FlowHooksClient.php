...
class FlowHooksClient extends ClientAbstract
{
    ...
    public function list(string $environmentName)
    {
        ...
        $url = $this->baseURL . '/environments/' . $environmentName . '/flowhooks';
    ...
    {
        $url = $this->baseURL . '/environments/' . $environmentName . '/flowhooks/' . $name;
