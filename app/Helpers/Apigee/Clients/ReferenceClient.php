...
class ReferenceClient extends ClientAbstract
{
    ...
    public function list(string $environmentName)
    {
        ...
        $url = $this->baseURL . '/environments/' . $environmentName . '/references';
    ...
    {
        $url = $this->baseURL . '/environments/' . $environmentName . '/references/' . $name;
