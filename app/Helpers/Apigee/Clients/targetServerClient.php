...
class targetServerClient extends ClientAbstract
{
    ...
    public function list(string $environmentName)
    {
        ...
        $url = $this->baseURL . '/environments/' . $environmentName . '/targetservers';
    ...
    {
        $url = $this->baseURL . '/environments/' . $environmentName . '/targetservers/' . $name;
